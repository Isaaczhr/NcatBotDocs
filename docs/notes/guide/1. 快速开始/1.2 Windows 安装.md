...
如果输出了版本号, 例如 `3.8.6`（2025.5.21）则说明安装成功。

### 检查 QQ 版本

NcatBot 需要 QQ 版本至少达到 `9.9.19` 才能正常运行, 如果你不知道你的 QQ 是哪个版本, 请前往[官网](https://im.qq.com)或者[点击这里的官方下载链接](https://dldir1.qq.com/qqfile/qq/QQNT/Windows/QQ_9.9.19_250523_x64_01.exe) 下载最新版 QQ 的安装包. 双击安装包更新即可.
